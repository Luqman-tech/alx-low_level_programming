 ...
 *
 * Description: When file can't close - exit code 98.
 */
void close_elf(int elf)
{
	if (close(elf) == -1)
...
/**
 * main - Shows information contained in
 ...
 *
 * Description: If file not ELF File or upon
 * function failing - exit code 98.
 */
