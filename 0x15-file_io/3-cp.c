...
/**
 * create_buffer - Allocates buffer for 1024 bytes.
 ...
 *
 * Description: When argument count's incorrect - exit code 97.
 * If file_from doesn't exist or unreadable - exit code 98.
 * If file_to can't be written to or created - exit code 99.
